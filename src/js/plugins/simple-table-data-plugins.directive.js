var simpleTableModules = [
  ...
  {
    name: 'pendingUpdates',
    template: '<key-value-list heading="Pending Updates" module-name="pending_updates" info="Number of available system updates."></key-value-list>'
  },
  {
    name: 'systemdFailed',
    template: '<table-data heading="Failed Systemd Services" module-name="systemd_failed" info="Systemd units in failed state."></table-data>'
  },
  {
    name: 'firewallOverview',
    template: '<key-value-list heading="Firewall Overview" module-name="firewall_overview" info="iptables chains and default policies."></key-value-list>'
  },
  {
    name: 'sslCertificates',
    template: '<table-data heading="SSL Certificates" module-name="ssl_certificates" info="SSL certificate expiry dates."></table-data>'
  }
]
