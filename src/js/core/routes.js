  ...
  $routeProvider
    ...
    .when('/system-status', {
      template: [
        ...
        '<pending-updates sortablejs-id="pending-updates"></pending-updates> ',
        '<systemd-failed sortablejs-id="systemd-failed"></systemd-failed> ',
      ].join(''),
    })
    ...
    .when('/basic-info', {
      template: [
        ...
        '<firewall-overview sortablejs-id="firewall-overview"></firewall-overview> ',
        '<ssl-certificates sortablejs-id="ssl-certificates"></ssl-certificates> ',
      ].join(''),
    })
